...
ROBERTA_PRETRAINED_MODEL_ARCHIVE_MAP = {
    ...
    'roberta-large-mnli': "https://s3.amazonaws.com/models.huggingface.co/bert/roberta-large-mnli-pytorch_model.bin",
     'roberta-large-bne': "https://huggingface.co/PlanTL-GOB-ES/roberta-large-bne/resolve/main/pytorch_model.bin",
}
...
class RobertaModelwithAdapter(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.model = RobertaModel.from_pretrained("/Users/pablo/Documents/GitHub/K-Flares/maria/roberta-large-bne/", output_hidden_states=True)
