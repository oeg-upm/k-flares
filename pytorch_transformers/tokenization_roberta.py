...
PRETRAINED_VOCAB_FILES_MAP = {
    'vocab_file':
    {
        ...
        'roberta-large-bne': "https://huggingface.co/PlanTL-GOB-ES/roberta-large-bne/blob/main/vocab.json",
    ...
    'merges_file':
    {
        ...
        'roberta-large-bne': "https://huggingface.co/PlanTL-GOB-ES/roberta-large-bne/blob/main/merges.txt",
    },
}
